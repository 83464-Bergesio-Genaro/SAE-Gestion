...
export function MyProfileContent(){
    ...
    const emailHasError = requiredError(datosPerfil.email)
        || (Boolean(datosPerfil.email) && !isValidEmail(datosPerfil.email));
    const phoneHasError = requiredError(datosPerfil.telefono)
        || (Boolean(datosPerfil.telefono) && !isValidPhone(datosPerfil.telefono));
    const dniHasError = requiredError(datosPerfil.dni)
        || (Boolean(datosPerfil.dni) && onlyDigits(String(datosPerfil.dni), 9).length !== 8);
    const cuilHasError = requiredError(datosPerfil.cuil)
        || (Boolean(datosPerfil.cuil) && onlyDigits(String(datosPerfil.cuil), 12).length !== 11);
                    ...
                    <Grid container spacing={2} mb={4}>
                        <Grid size={{ xs: 12 ,md:4}}>
                            <SAETextField
                                ...
                                helperText={requiredError(datosPerfil.legajo) ? "El legajo es obligatorio" : ""}
                            />
                        </Grid>
                        <Grid size={{ xs: 12, md: 4 }}>
                            <SAETextField
                                ...
                                helperText={requiredError(datosPerfil.nombres) ? "El nombre es obligatorio" : ""}
                            />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                            <SAETextField
                                ...
                                helperText={requiredError(datosPerfil.apellidos) ? "El apellido es obligatorio" : ""}
                            />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                            <SAETextField
                                ...
                                required
                                error={dniHasError}
                                helperText={dniHasError ? "El DNI debe tener 8 dígitos" : ""}
                            />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                            <SAETextField
                                ...
                                required
                                error={cuilHasError}
                                helperText={cuilHasError ? "El CUIL debe tener 11 dígitos" : ""}
                            />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                              <SAETextField
                                  ...
                                  helperText={requiredError(datosPerfil.fecha_nacimiento) ? "La fecha de nacimiento es obligatoria" : ""}
                              />
                        </Grid>
                    ...
                    <Grid container spacing={2} mb={4}>
                        ...
                        <Grid size={{ xs: 12, md: 6 }}>
                            <SAETextField
                                ...
                                error={emailHasError}
                                required
                                helperText={emailHasError ? "Ingresá un correo válido. Ejemplo: nombre@dominio.com" : ""}
                            />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 6 }}>
                            <SAETextField
                                ...
                                error={phoneHasError}
                                required
                                helperText={phoneHasError ? "Completá el teléfono con el formato +54 351 123-4567" : ""}
                            />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 3 }}>
                            <SAETextField
                                ...
                                helperText={requiredError(addressParts[0]) ? "La provincia es obligatoria" : ""}
                            />
                        </Grid>
                        <Grid size={{ xs: 12, md: 3 }}>
                            <SAETextField
                                ...
                                helperText={requiredError(addressParts[1]) ? "La ciudad/localidad es obligatoria" : ""}
                            />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                            <SAETextField
                                ...
                                helperText={requiredError(addressParts[2]) ? "La calle es obligatoria" : ""}
                            />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 2 }}>
                            <SAETextField
                                ...
                                helperText={requiredError(addressParts[3]) ? "La altura es obligatoria" : ""}
                            />
                        </Grid>
