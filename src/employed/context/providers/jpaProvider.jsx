...
export function JPAProvider({ children }) {
    ...
    const eventoColumns = useMemo(() => generateColumns(EMPTY_EVENTO_PUBLICO,openEditEventoPublico,openDeleteEvento),[openEditEventoPublico,openDeleteEvento]);
    const standsColumns = useMemo(() => generateColumns(EMPTY_STANDS,openEditStands,openDeleteEvento),[openEditStands,openDeleteEvento]);
    const interesadosColumns = useMemo(() => generateColumns(EMPTY_INTERESADOS,openEditInteresados,openDeleteInteresados),[openEditInteresados,openDeleteInteresados]);
  ...
  return (
    <JPAContext.Provider
      value={{
        ...
        openCreateStands,openEditStands,openDeleteStands,handleStandSave,

        interesadosRows,interesadosColumns,loadingInteresados,
        openCreateInteresados,openEditInteresados,openDeleteInteresados,handleInteresadoSave,

        dialogOpen,dialogType,dialogMode,dialogData,dialogSaving,dialogError,
        setDialogData,setDialogOpen,setDialogError,setSnackbarOpen
      }}
    >
      {children}
    </JPAContext.Provider>
