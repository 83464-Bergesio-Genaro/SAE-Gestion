    ...
    <Box
        sx={{
            ...
            <Container maxWidth="xl">
                ...
                <Box
                    ...
                    <Box sx={{ maxWidth: 700 }}>
                        ...
                        >
                            Gestión de las capacidades medicas de nuestra area
                        </Typography>
                ...
                <Card sx={{ borderRadius: 4, boxShadow: "0 18px 45px rgba(21, 61, 113, 0.08)", overflow: "hidden", mt: 3,mb:4 }}>
                    <Box
                        sx={{
                             ...
                             <Grid container spacing={1} >
                                ...
                                <Grid size={{xs:12}} m={0}>
                                    <SAETextField
                                        ...
                                        onChange={(e) => handleDialogChange("descripcion", e.target.value)}
                                        multiline
                                        fullWidth
                                ...
                                <FormControlLabel
                                    ...
                                    <Switch
                                        ...
                                        color="primary"
                                        /> }
                                        label={dialogData.activo ? "Especialidad Activa" : "Especialidad NO activa"}
                                    />)}
                            </Grid>
                    </>             
            ...
            <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="sm" fullWidth>
                <DialogTitle sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <Typography variant="h6" component="span" sx={{ fontWeight: "bold" }}>
                        { dialogMode === "create" ? "Nuevo Empleado" : //Primera condicion
                         dialogMode === "edit" ? "Editar Empleado": //Segunda condicion
                         "Registrar Falta" } 
                    </Typography>
                    <IconButton onClick={() => setDialogOpen(false)} size="small">
                        <CloseIcon />
                                ...
                                <Grid container spacing={1} >
                                    ...
                                    <Grid size={{xs:12}} my={1}>
                                        <SAETextField
                                            ...
                                            onChange={(e) => handleDialogChange("observacion", e.target.value)}
                                            multiline
                                            fullWidth
                                   ...
                                   <SAETextField
                                        ...
                                        onChange={(e) => handleDialogChange("fecha_alta", e.target.value)}
                                        fullWidth
                            ...
                            <Card sx={{ bgcolor: "rgba(235, 235, 41, 0.7)", border: "1px solid rgba(235, 41, 41, 0.1)" }}>
                                <CardContent sx={{ p: 2 }}>
                                    ...
                                    <Typography variant="body2" color="textSecondary">
                                        Al crear el personal medico se le solicitara el CUIL, el mismo NO podra ser modificado despues,
                                         es decir, que despues de la carga de esta persona solo el equipo de sistemas podra eliminar dicho registro.
                                    </Typography>
                                </CardContent>
                            </Card>
                            )}
                             <Grid container spacing={1} >
                                ...
                                <Grid size={{xs:12}} m={0}>
                                    <SAETextField
                                        ...
                                        onChange={(e) => handleDialogChange("apellido", e.target.value)}
                                        fullWidth
                                    />
                                </Grid>
                                ...
                                <Grid size={{xs:12}} m={0}>
                                    <Autocomplete
                                        ...
                                        onChange={(event, newValue) => {
                                            ...
                                            if (newValue) {
                                                handleDialogChange("id_especialidad", newValue.id);
                                            } else {
                                        ...
                                        value={especialidades.find(especialidad => especialidad.id === dialogData.id_especialidad)} // Pasa el objeto completo
                                        renderInput={(params) => 
                                        <TextField
                                            {...params}
                                            label="Especialidad"
                                ...
                                {dialogMode === "edit" && (
                                <>
                                <Card sx={{ bgcolor: "rgba(226, 71, 71, 0.7)", border: "1px solid rgba(235, 41, 41, 0.1)" }}>
                                    <CardContent sx={{ p: 2 }}>
                                        <Typography variant="subtitle2" color="textPrimary" fontWeight={600} gutterBottom>
                                            IMPORTANTE! 
                                            </Typography>
                                        ...
                                        <Switch
                                            ...
                                            color="primary"
                                            /> }
                                            label={dialogData.activo ? "Personal Activo" : "Personal NO activo"}
                                        />
                                    </>
                                )}
                        </Grid>
                             ...
                             <Grid container spacing={1} >
                                ...
                                <Grid size={{xs:12,md:3}} m={0}>
                                    <SAETextField
                                        ...
                                        onChange={(e) => handleDialogChange("cupo_maximo", e.target.value)}
                                    />     
                                </Grid>                                    
                                <Grid size={{xs:12,md:6}} m={0}>
                                    ...
                                    <SAETextField
                                        ...
                                        onChange={(e) => handleDialogChange("nombre_curso", e.target.value)}
                                        fullWidth
                                    />
                                </Grid>
                                <Grid size={{xs:12}} m={0}>
                                    <SAETextField
                                        ...
                                        onChange={(e) => handleDialogChange("nombre_docente", e.target.value)}
                                        fullWidth
                                    />
                                </Grid>
                                <Grid size={{xs:12,sm:6}} m={0}>
                                    <SAETextField
                                        ...
                                        onChange={(e) => handleDialogChange("fecha_inicio", e.target.value)}
                                        fullWidth
                                        slotProps={{ inputLabel: { shrink: true } }}
                                    />    
                                </Grid>
                                <Grid size={{xs:12,sm:6}} m={0}>
                                    <SAETextField
                                        ...
                                        onChange={(e) => handleDialogChange("fecha_fin", e.target.value)}
                                        fullWidth
                                        slotProps={{ inputLabel: { shrink: true } }}
                                    />    
                                </Grid>                                                  
                                ...
                                <FormControlLabel
                                    ...
                                    <Switch
                                        ...
                                        color="primary"
                                        /> }
                                        label={dialogData.activo ? "Curso Activo" : "Curso NO activo"}
                                    />)}
