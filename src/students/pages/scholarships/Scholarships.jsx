...
function ScholarshipsContent() {
  ...
  const {
    ...
    ,openDialog,documentos,documentosEconomica,preview,cbu,cbuGuardado,openPopup,documentoAEliminar,cargarTiposDocumento,subirDocumentoEstudiante,
    cargarMisBecas,handleArchivoChange,handleCbuChange,handleGuardarCbu,
