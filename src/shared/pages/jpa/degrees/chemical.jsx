...
import DegreesInfoPage from "./degreesInfo";
import {
  Container,
  Typography,
  List,
...
export default function SharedJPAQuimica() {
  ...
  return(
    <DegreesInfoPage banner={imageDirBanner} title={"Ingenieria Química"} subtitle={"Transformá la industria a través de la ciencia."}/>
  );
