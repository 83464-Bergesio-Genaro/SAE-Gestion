          ...
          <>
            ...
            >
              ...
              <SAETextField
                ...
                onChange={(e) =>
                  handleChange("titulo_publicacion", e.target.value)
                }
              />
              <SAETextField
              ...
              <Box sx={{ display: "flex", gap: 2 }}>
                ...
                <SAETextField
                  ...
                  onChange={(e) =>
                    handleChange("fecha_vigencia", e.target.value)
                  }
                  slotProps={{ inputLabel: { shrink: true } }}
                />
              </Box>
              <FormControlLabel
                control={
                  <SAESwitch
                    ...
                    onChange={(e) =>
                      handleChange("no_dar_baja", e.target.checked)
                    }
                  />
                }
              ...
              <Box sx={{ display: "flex", justifyContent: "center", gap: 1 }}>
                {PRIORIDAD_OPTIONS.map((opt) => {
                  const isSelected =
                    ...
                    (opt.value === 0 &&
                      nuevaData.prioridad !== 1 &&
                      nuevaData.prioridad !== 2);
                  return (
                    <Chip
                      key={opt.value}
                      label={opt.label}
                ...
                {docMode === "subir" ? (
                  ...
                  <Box>
                    ...
                    <TableContainer
                      component={Paper}
                      variant="outlined"
                      sx={{ maxHeight: 245, overflowY: "auto" }}
                    >
